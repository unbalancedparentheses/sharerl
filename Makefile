...
DEPS = cowboy lager jiffy mixer sync erlport uuid
...
dep_uuid = git git@github.com:okeuday/uuid.git master
...
SHELL_OPTS = +pc unicode -name ${PROJECT}@`hostname` -s ${PROJECT} -s sync -config rel/sys.config
